...
export default function Footer({ footerPages = [] }: FooterProps) {
  ...
  return (
    <footer className="bg-african-black-900 text-gray-300 border-t-4 border-african-gold-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/donate" className="hover:text-african-gold-400 transition-colors">
                  Donate
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-african-red-600 transition-colors"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-african-gold-500 transition-colors"
